...
## 2026-02-15 - ¼±¹ßÈ­/StartSpeaking Àç½ÃÀÛ ¾ÈÁ¤È­ º¸°­
- ºê·£Ä¡: `mun-cleanup-server`
- ¸ñÀû:
  - ½Ç½Ã°£ ÁúÀÇ¿¡¼­ °£ÇæÀûÀ¸·Î "¸ğ¸¥´Ù"°¡ ¸ÕÀú ³ª¿À´Â ¼±¹ßÈ­ ¿ÏÈ­
  - `Stop Speaking -> Start Speaking` Àç½ÃÀÛ ½Ã STT/ÀÀ´äÀÌ ¸ØÃß´Â Çö»ó ¿ÏÈ­

### server.py º¯°æ
- »ç¿ëÀÚ STT `recognizing` ÀÌº¥Æ® ÇÚµé·¯ Ãß°¡
  - »ç¿ëÀÚ ¹ßÈ­ Áß/Á÷ÈÄ ÃÊ±â ±¸°£¿¡ ¸ğµ¨ ¿Àµğ¿À¸¦ Àá½Ã °ÔÀÌÆ®(`speech_capture_gate`)ÇÏµµ·Ï Àû¿ë
  - °°Àº ±¸°£¿¡¼­ direct-audio ÀÔ·ÂÀ» Âª°Ô ÇÏµå ºí·Ï(`block_direct_audio_until`)ÇØ pre-context ÀÀ´ä ¹ß»ı °¡´É¼º Ãà¼Ò
- `receive_from_client` °æ·Î¿¡ ÇÏµåºí·Ï ÀÚµ¿ÇØÁ¦ ¾ÈÀüÀåÄ¡ Ãß°¡
  - `block_direct_audio_until` °æ°ú ½Ã `block_direct_audio=False`·Î ÀÚµ¿ ÀüÈ¯
- `send_to_client` °æ·Î¿¡ `speech_capture_gate` Ã¼Å© Ãß°¡
  - »ç¿ëÀÚ ¹ßÈ­ finalize Á÷Àü/Á÷ÈÄ¿¡ µé¾î¿À´Â Á¶±â ¸ğµ¨ ¿Àµğ¿À¸¦ µå·Ó

### temp_front/app/page.tsx º¯°æ
- `startAudioProcessing()` ½ÃÀÛ ½Ã ¹æ¾îÀû ¿Àµğ¿À ¸®¼Ò½º Á¤¸® Ãß°¡
  - ÀÌÀü `processor/source/micStream/inputContext`¸¦ ¸ÕÀú Á¤¸®/Á¾·áÇÑ µÚ »õ ¼¼¼Ç »ı¼º
- ¿Àµğ¿À Àü¼Û ½Ã `websocket.send()` ¿¹¿Ü Ã³¸® Ãß°¡
- `stopAudioProcessing()`¿¡¼­ `onaudioprocess`¸¦ null·Î ¸í½Ã ÇØÁ¦

### ±â´ë È¿°ú
- ¶ó¿ìÆÃ/ÄÁÅØ½ºÆ® ÁÖÀÔ Àü¿¡ ¸ğµ¨ÀÌ ¼±ÀÀ´äÇÏ´Â Çö»ó ºóµµ °¨¼Ò
- Speak ¹öÆ° Àç½ÃÀÛ ½Ã ¿Àµğ¿À ³ëµå ²¿ÀÓ/Áßº¹À¸·Î ÀÎÇÑ ¹«ÀÀ´ä Çö»ó ¿ÏÈ­
